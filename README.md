...
Präsentation: [📄 Lichttechnik_Projekt.pdf](Lichttechnik_Projekt.pdf)
...
- Live-Monitor als Kontrollbild (nicht 1:1 farbkalibriert)
- grandMA2 zur Steuerung der Studiolampen (Cues/Szenen)

## Lessons Learned:
- Hintergrund Farben Haben staken Einfluss auf die Stimmung und szene
- Licht Reflektiert stark auf Hellen Oberflächen Wirkung Bedenken & Beachten
- Übertragung auf den Monitor Stark Abweichend Kalibrierung von Farben notwendig
- Szenen als Cues speichern → schneller A/B-Vergleich
- Kontrast/Farbtemperatur verändert die Wirkung stärker als erwartet
- Licht und Farben haben Starke aussagskraft auf stimmung und Inszinierungen.
- Messungen direkt am Leuchtmittel sind nur eingeschränkt auf die Lichtwirkung am Motiv übertragbar, fehlerquellen mischlicht und Abstand/Raumreflexionen
